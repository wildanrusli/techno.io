    ...
    <div class="footer bg-secondary text-light">
        <div class="row px-5 py-3">
            <div class="col-sm">
                <h6>Kategori</h6>
                <p class="foot-item">
                    <a href="<?= url ?>user/produk.php/?kategori=Sepakbola">Sepakbola</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=Lari">Lari</a><br>
                    <a href="<?= url ?>user/produk.php/?kategori=Futsal">Futsal</a><br>
                </p>
            </div>
            <div class="col-sm">
                <h6>Halaman</h6>
        ...
        <div class="row justify-content-center">
            <div class="text-center border-top w-50 py-3 bg-secondary">
